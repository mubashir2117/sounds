...
.container-a .music-container{
    display: inline;
    align-items: center;
    flex-flow: column;
}

.container-a .music-container .box{
height: 100px;
width: 40%;
display: flex;
align-items: center;
...
.container-a .music-container .box .image{
    height: 100%;
    width: 25%;
}
.container-a .music-container .box .image img{
    height: 100%;
    width: 100%;
    object-fit: cover;
}
.container-a .music-container .box .music{
width: 75%;
}
.container-a .music-container .box .audio{
    width: 100%;
    outline: none;
}
 ...
 <div class="container">
   <div class="row">
     <div class="col-lg-6 col-md-12">
      <div class="container">
        <img class="img-fluid" src="images/aima1.jpg" alt="" width="300px" height="440px">
      </div>
     </div>
     <div class="col-lg-6 col-md-12">
      <h1 style="font-family: 'Gill Sans'; color: rgb(216, 11, 86); font-size: 80px;">Iam Aima Baig </h1>
     <h2 style="font-family: 'Gill Sans'; color:  rgb(216, 11, 86); font-size: 50px;">Pakistani Singer</h2>
     <h3 style="font-family: 'Gill Sans'; color: rgb(216, 11, 86); font-size: 50px;"> Vocalist <span style="color: bisque;">&</span> guitarist</h3>
 </div>
</div>
</div>
<br><br>
<div class="container-a">
 ...
 <h1  style="font-family: 'Gill Sans'; color: rgb(216, 11, 86);text-align: center;">Your Playlist, Your Rules</h1>
  ...
  <div class="music-container">
      ...
      <div class="box">
       ...
       <div class="music">
         ...
         <div class="box">
          <div class="image">
         <img src="images/gittar.jpg" alt=""> </div>
       <div class="music">
          <audio src="" controls></audio></div>
         </div>
         ...
         <div class="box">
          <div class="image">
         <img src="images/headphone.jpg" alt=""> </div>
       <div class="music">
          <audio src="" controls></audio></div>
         </div>
         ...
         <div class="box">
          <div class="image">
         <img src="images/aimabaig.jpg" alt=""> </div>
       <div class="music">
          <audio src="" controls></audio></div>
         </div>
         ...
         <div class="box">
          <div class="image">
         <img src="images/headphone3.jpg" alt=""> </div>
       <div class="music">
          <audio src="" controls></audio></div>
         </div>
         ...
         <div class="box">
          <div class="image">
         <img src="images/aima5.jpg" alt=""> </div>
       <div class="music">
          <audio src="" controls></audio></div>
         </div>
         ...
         <div class="box">
          <div class="image">
         <img src="images/mic.jpg" alt=""> </div>
       <div class="music">
          <audio src="" controls></audio></div>
         </div>
         ...
         <div class="box">
          <div class="image">
         <img src="images/aima4.jpg" alt=""> </div>
       <div class="music">
          <audio src="" controls></audio></div>
         </div>
